...
export const BADGES = [
  {
    ...
    name: 'K45',
    cat: 'Kilómetros',
    desc: 'Acumula 45 km corriendo durante el mes.',
  ...
  },
  {
    ...
    name: '900 Min',
    cat: 'Tiempo',
    desc: 'Acumula 900 minutos corriendo.',
  ...
  },
  {
    ...
    name: 'Z2 Master',
    cat: 'Base aeróbica',
    desc: 'Completa 8 entrenamientos en Zona 2.',
  ...
  },
  {
    ...
    name: 'Strong Runner',
    cat: 'Fuerza',
    desc: 'Completa 8 sesiones de fuerza.',
  ...
  },
  {
    ...
    name: 'Climber',
    cat: 'Desnivel',
    desc: 'Acumula 400 m de desnivel positivo (D+).',
  ...
  },
  {
    ...
    name: 'Long Run',
    cat: 'Resistencia',
    desc: 'Completa 4 fondos programados.',
  ...
  },
  {
    ...
    name: 'Speed',
    cat: 'Pista',
    desc: 'Completa 3 sesiones de pista.',
    how: 'Series, intervalos, fartlek o tempo en pista. Cualquier entreno con cambios de ritmo planificados.',
    type: 'count',
    goal: 3,
    source: 'device',
    fieldLabel: '¿Completaste una sesión de pista?',
    color: '#facc15'
  },
  {
    id: 'consistency',
    ...
    name: 'Consistency',
    cat: 'Constancia',
    desc: 'Corre al menos 3 días por semana, 4 semanas seguidas.',
    how: 'Marca la semana como cumplida cuando hayas corrido 3 o más días en ella.',
    type: 'weeks',
    goal: 4,
    source: 'manual',
    fieldLabel: '¿Esta semana ya corriste 3 días o más?',
    color: '#22d3ee'
  },
  {
    id: 'recovery',
